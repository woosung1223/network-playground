...
const (
	Bidirectional_GetServerResponse_FullMethodName = "/proto.Bidirectional/GetServerResponse"
)
...
func (c *bidirectionalClient) GetServerResponse(ctx context.Context, opts ...grpc.CallOption) (Bidirectional_GetServerResponseClient, error) {
	...
	x := &bidirectionalGetServerResponseClient{ClientStream: stream}
	return x, nil
}
...
func _Bidirectional_GetServerResponse_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BidirectionalServer).GetServerResponse(&bidirectionalGetServerResponseServer{ServerStream: stream})
}
...
var Bidirectional_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.Bidirectional",
