...
const (
	ServerStreaming_GetServerResponse_FullMethodName = "/proto.ServerStreaming/GetServerResponse"
)
...
func (c *serverStreamingClient) GetServerResponse(ctx context.Context, in *Number, opts ...grpc.CallOption) (ServerStreaming_GetServerResponseClient, error) {
	...
	x := &serverStreamingGetServerResponseClient{ClientStream: stream}
...
func _ServerStreaming_GetServerResponse_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ServerStreamingServer).GetServerResponse(m, &serverStreamingGetServerResponseServer{ServerStream: stream})
}
...
var ServerStreaming_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.ServerStreaming",
